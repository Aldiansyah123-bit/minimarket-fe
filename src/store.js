...
const initialBrands = [
  { id: 'b1', name: 'Indomie', description: 'Mi instan' },
  ...
  { id: 'b5', name: 'Unilever', description: 'Perawatan' },
  { id: 'b6', name: 'P&G', description: 'Rumah tangga' },
  { id: 'b7', name: 'Nestle', description: 'Makanan & minuman' },
  { id: 'b8', name: 'Sari Roti', description: 'Roti' },
  { id: 'b9', name: 'Kapal Api', description: 'Kopi' },
