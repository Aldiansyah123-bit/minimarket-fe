...
export default function LoginPage() {
  ...
  const fillLogin = (acc: { username: string; password: string }) => {
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-white space-y-6 hidden lg:block">
          ...
          <p className="text-lg text-blue-100 leading-relaxed">
            Kelola toko Anda dengan mudah. Sistem POS modern untuk minimarket dengan fitur lengkap.
          </p>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg shadow-blue-200"
            >
              <i className="fas fa-right-to-bracket mr-2"></i> Masuk
            </button>
          </form>
